...
SisAtendimento.instancia().insertAtendimento(p);// não sei pra que serve, se tirar não dá em nada
session.setAttribute("atendimento", p); //abre uma sessao chamada processo e o valor dela é o que setei no Processo P
